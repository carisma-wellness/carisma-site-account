 ...
 */
export function step3DoorsHTML(opts: DoorsOptions): string {
  ...
  return (
    `<section class="carisma-step3 carisma-step3--doors" data-cw-qc="${STEP3_QC}" data-cw-step3-view="doors">` +
...
/* ── State B: the member confirm card ───────────────────────────────────── */
 ...
 */
export function step3ConfirmHTML(model: ConfirmModel): string {
  ...
  return (
    `<section class="carisma-step3 carisma-step3--confirm" data-cw-qc="${STEP3_QC}" data-cw-step3-view="${model.editing ? "confirm-edit" : "confirm"}">` +
    `<h2 class="carisma-step3__heading">Your details</h2>` +
 ...
 */
export function marketingTickHTML(field: MarketingConsentField): string {
  if (!field.shown) return "";
  return (
    `<label class="carisma-step3__consent">` +
