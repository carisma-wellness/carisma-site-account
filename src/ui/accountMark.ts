...
export function accountMarkState(cookie: string | null | undefined): AccountMarkState {
 ...
 */
export function accountMarkServerHTML(opts: AccountMarkOptions = {}): string {
  ...
  const label = opts.label
    ...
    : "";
  return (
    `<a class="${escapeHtml(cls)}" ${ACCOUNT_MARK_ATTR} data-cw-nav="account" ` +
