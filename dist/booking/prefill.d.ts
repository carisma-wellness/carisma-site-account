...
export declare function joinE164(countryCode: string, national: string): string;
/**
 ...
 */
export declare function splitE164(value: string, fallbackCountryCode?: string): {
    countryCode: string;
    phone: string;
};
/** A member profile has a usable phone only when both halves are present (8.4). */
export declare function profileHasPhone(profile: MemberProfile): boolean;
/** A member profile has a usable name only when both halves are present (8.4). */
export declare function profileHasName(profile: MemberProfile): boolean;
/**
 ...
 */
export declare function guestFromProfile(profile: MemberProfile): GuestDetails;
