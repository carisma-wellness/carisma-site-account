...
export function buildCheckoutPayload(input) {
    ...
    if (!isMember && input.turnstileToken)
        payload.turnstileToken = input.turnstileToken;
    if (input.origin)
    ...
    if (input.giftCardCode)
        payload.giftCardCode = input.giftCardCode;
    if (input.promoCode)
        payload.promoCode = input.promoCode;
    return payload;
}
/**
 ...
 */
export function toClientCheckoutBody(payload, fallbackCountryCode = "") {
    ...
    if (payload.giftCardCode)
        body.giftCardCode = payload.giftCardCode;
 ...
 */
export function makeClientCheckout(deps) {
    ...
    return async function startClientCheckout(payload) {
